...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-gray-50 via-white to-blue-50 pt-20 pb-32 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-6xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
              Stop Letting Tasks<br />
              <span className="text-blue-600">Slip Through the Cracks</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="#demo"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl"
              >
                Book a Demo
              </a>
              <a
                href="#how-it-works"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-gray-700 bg-white border-2 border-gray-200 rounded-lg hover:border-gray-300 transition-all"
              >
                See How It Works
              </a>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-4xl font-bold text-blue-600 mb-2">12hrs</div>
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Missed tickets</div>
              </div>
              <div className="text-center">
      ...
      <section className="pt-40 pb-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-60">
            ...
            <div className="text-2xl font-bold text-gray-400">OpsTech</div>
            <div className="text-2xl font-bold text-gray-400">FlowOps</div>
            <div className="text-2xl font-bold text-gray-400">TeamSync</div>
            <div className="text-2xl font-bold text-gray-400">AutoFlow</div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow">
              <div className="w-14 h-14 bg-blue-600 rounded-lg flex items-center justify-center text-white text-2xl mb-6">
                🎯
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Smart Task Routing</h3>
            ...
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Deep Integrations</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Built for Security</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-24 px-6 bg-gradient-to-br from-blue-600 to-blue-700 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              <div className="w-16 h-16 bg-white text-blue-600 rounded-full flex items-center justify-center text-3xl font-bold mx-auto mb-6">
                1
              </div>
            ...
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Operations Director, FlowOps</div>
                </div>
              </div>
            </div>
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Head of Ops, Agency Co.</div>
                </div>
              </div>
            </div>
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">VP Operations, TeamSync</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* CTA Footer */}
      <section id="demo" className="py-32 px-6 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <form className="max-w-2xl mx-auto bg-white rounded-2xl p-8 shadow-2xl">
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <input
                type="text"
                placeholder="Full Name"
                required
                className="px-4 py-3 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-600"
              />
              <input
                type="email"
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-900 mb-6 focus:outline-none focus:ring-2 focus:ring-blue-600"
            />
            <button
              type="submit"
              className="w-full bg-blue-600 text-white font-semibold py-4 rounded-lg hover:bg-blue-700 transition-all text-lg shadow-lg hover:shadow-xl"
            >
              Book a Demo
            </button>
